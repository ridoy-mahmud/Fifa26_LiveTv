// Default channel catalog — merged from:
//   • Original defaults
...
export interface Channel {
  ...
  logo: string;
  url: string;
  fallbackUrl?: string; // tried automatically if primary url fails
  featured?: boolean;
  order?: number;
}

const _raw: Omit<Channel, "id">[] = [
  // ── FIFA+ ──────────────────────────────────────────────────────────────
  ...
  { name: "TUDN HD", group: "Football", logo: "https://imglink.cc/cdn/Tf3GP8uGY_.jpg", url: "http://74.208.30.121/a192/mono.m3u8" /* CDN IP — handled by server proxy */ },
  { name: "TUDN 1080", group: "Football", logo: "https://imglink.cc/cdn/Tf3GP8uGY_.jpg", url: "http://162.19.255.233:8080/play/UNbAl57p9hXZClOu56FCTVL9TbgOeYnXUEC2UjoDBYk/m3u8" /* CDN IP — handled by server proxy */ },
  ...
  { name: "Discovery Bangla", group: "Documentary", logo: "https://imglink.cc/cdn/mv5xd7yy0d.png", url: "http://103.180.212.191:3500/live/573.m3u8" /* proxy-handled */ },
  { name: "Discovery Hindi", group: "Documentary", logo: "https://imglink.cc/cdn/mv5xd7yy0d.png", url: "http://103.180.212.191:3500/live/3428.m3u8" /* proxy-handled */ },
...
export const DEFAULT_CHANNELS: Channel[] = _raw.map((c, i) => ({
...
export const FALLBACK_LOGO =
  "https://i.ibb.co.com/vnbkF0r/fifa-world-cup-2026-logo-png-seeklogo-665644.png";

export const ALL_GROUPS: ChannelGroup[] = [
  "Football",
  "Sports",
  "Cricket",
  "Entertainment",
