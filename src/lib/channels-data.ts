...
const _raw: Omit<Channel, "id">[] = [
  ...
  // TUDN kept as-is (CDN IPs may be valid); note added
  {
    ...
    url: "http://74.208.30.121/a192/mono.m3u8" /* CDN IP — handled by server proxy */,
  },
  {
    name: "TUDN 1080",
    group: "Football",
    logo: "https://imglink.cc/cdn/Tf3GP8uGY_.jpg",
    url: "http://162.19.255.233:8080/play/UNbAl57p9hXZClOu56FCTVL9TbgOeYnXUEC2UjoDBYk/m3u8" /* CDN IP — handled by server proxy */,
  },
  {
    name: "Tyc Sports",
    group: "Football",
  ...
  // Discovery/Geography/Animal Planet: http private IPs kept — server proxy handles these
  {
    ...
    url: "http://103.180.212.191:3500/live/573.m3u8" /* proxy-handled */,
  },
  {
    name: "Discovery Hindi",
    group: "Documentary",
    logo: "https://imglink.cc/cdn/mv5xd7yy0d.png",
    url: "http://103.180.212.191:3500/live/3428.m3u8" /* proxy-handled */,
  },
  {
    name: "Geography HD",
    group: "Documentary",
    logo: "https://imglink.cc/cdn/eEZmseF3Tb.jpg",
    url: "http://202.70.146.135:8000/play/a05o/index.m3u8" /* proxy-handled */,
  },
  {
