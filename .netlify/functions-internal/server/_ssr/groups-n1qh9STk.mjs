...
import { u as useServerFn, a as listMatches, l as listTeams } from "./router-C62mR_UY.mjs";
import { M as MATCHES, T as TEAMS, G as GROUPS, a as groupStandings, m as matchesByGroup, f as flagUrl } from "./worldcup-data-CM7yYn8t.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6 lg:grid-cols-2", children: GROUPS.map((g) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "overflow-hidden rounded-xl border border-border bg-card shadow-card", children: [
        ...
        groupMatches.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3 border-t border-border bg-background/40 p-4 sm:grid-cols-2", children: groupMatches.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx(MatchCard, { match: m }, m.id)) })
      ] }, g);
    }) })
  ] });
}
