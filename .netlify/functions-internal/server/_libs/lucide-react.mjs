...
const FastForward = createLucideIcon("fast-forward", __iconNode$z);
const __iconNode$y = [
  [
    "path",
    {
...
const PictureInPicture2 = createLucideIcon("picture-in-picture-2", __iconNode$l);
const __iconNode$k = [
  [
    "path",
    {
...
const Rewind = createLucideIcon("rewind", __iconNode$g);
const __iconNode$f = [
