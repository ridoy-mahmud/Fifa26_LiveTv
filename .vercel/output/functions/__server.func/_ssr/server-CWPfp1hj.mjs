...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-H01jGP47.mjs");
...
const manifest = {
  "89f029f4fc21ed092423cd54f44fb61078423691288a3a89663a6e0973cd86ea": {
    ...
    importer: () => import("./admin.functions-QdmByXVh.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DWtAOtfv.mjs").then((n) => n.r),
    import("./start-OB7sjF-u.mjs"),
